...
#define MMIO_QA7_SIZE	0x0000000000001000
...
#define SYSTEMTIMER ((volatile __attribute__((aligned(4))) struct SystemTimerRegisters*)(uintptr_t)(MMIO_BASE + 0x3000))
#define IRQ ((volatile __attribute__((aligned(4))) struct IrqControlRegisters*)(uintptr_t)(MMIO_BASE + 0xB200))
#define ARMTIMER ((volatile __attribute__((aligned(4))) struct ArmTimerRegisters*)(uintptr_t)(MMIO_BASE + 0xB400))
#define MAILBOX ((volatile __attribute__((aligned(4))) struct MailBoxRegisters*)(uintptr_t)(MMIO_BASE + 0xB880))
#define MINIUART ((volatile struct MiniUARTRegisters*)(uintptr_t)(MMIO_BASE + 0x00215040))
#define PL011UART ((volatile struct PL011UARTRegisters*)(uintptr_t)(MMIO_BASE + 0x00201000))
